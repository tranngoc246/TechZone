...
namespace TechZone.Web.Api
{
    ...
    public class ApplicationRoleController : ApiControllerBase
    {
        ...
        public ApplicationRoleController(IErrorService errorService, IMappingService mappingService,
        ...
        public HttpResponseMessage GetListPaging(HttpRequestMessage request, int page, int pageSize, string filter = null)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                IEnumerable<ApplicationRoleViewModel> modelVm = _mappingService.Mapper.Map<IEnumerable<ApplicationRole>, IEnumerable<ApplicationRoleViewModel>>(model);
